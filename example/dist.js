...
var App = function App() {
  return (0, _main.setContext)({ foo: 'bar' }, _react2.default.createElement(MyApp, null));
};
...
var Comp = function Comp() {
  return (0, _main.getContext)(function (_ref) {
    var foo = _ref.foo;
    return _react2.default.createElement(
      'h1',
      null,
...
},{"../src/main.js":163,"react":159,"react-dom":3}],2:[function(require,module,exports){
...
var ContextUnwrapper = function (_Component) {
  _inherits(ContextUnwrapper, _Component);

  function ContextUnwrapper() {
    _classCallCheck(this, ContextUnwrapper);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ContextUnwrapper).apply(this, arguments));
  }

  _createClass(ContextUnwrapper, [{
    key: 'render',
    value: function render() {
      var fn = this.props.fn;
      return fn(this.context[_constants.CONTEXT_KEY]);
    }
  }]);

  return ContextUnwrapper;
}(_react.Component);

ContextUnwrapper.contextTypes = _defineProperty({}, _constants.CONTEXT_KEY, _react2.default.PropTypes.object);

ContextUnwrapper.propTypes = {
  fn: _react2.default.PropTypes.func
};

exports.default = ContextUnwrapper;

},{"./constants.js":162,"react":159}],161:[function(require,module,exports){
'use strict';
...
var ContextWrapper = function (_Component) {
  ...
  function ContextWrapper() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(ContextWrapper).apply(this, arguments));
  }

  _createClass(ContextWrapper, [{
    key: 'getChildContext',
    value: function getChildContext() {
      return _defineProperty({}, _constants.CONTEXT_KEY, this.props.context);
    }
  }, {
    key: 'render',
    value: function render() {
...
ContextWrapper.childContextTypes = _defineProperty({}, _constants.CONTEXT_KEY, _react2.default.PropTypes.object);

ContextWrapper.propTypes = {
  context: _react2.default.PropTypes.object,
  el: _react2.default.PropTypes.element
};

exports.default = ContextWrapper;

},{"./constants.js":162,"react":159}],162:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var CONTEXT_KEY = exports.CONTEXT_KEY = '__SECRET_CONTEXT_KEY__';
...
var _ContextWrapper = require('./ContextWrapper.js');

var _ContextWrapper2 = _interopRequireDefault(_ContextWrapper);

var _ContextUnwrapper = require('./ContextUnwrapper.js');

var _ContextUnwrapper2 = _interopRequireDefault(_ContextUnwrapper);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function setContext(context, el) {
  return _react2.default.createElement(_ContextWrapper2.default, { context: context, el: el });
}

function getContext(fn) {
  return _react2.default.createElement(_ContextUnwrapper2.default, { fn: fn });
}

},{"./ContextUnwrapper.js":160,"./ContextWrapper.js":161,"react":159}]},{},[1]);
